...
model.fit(X, y)
print("Modèle XGBRegressor entraîné sur toutes les villes, tous polluants, toutes dates.")
...
df_pred.to_csv("/Users/akkouh/Desktop/scd3/prediction_1year_all_cities_xgboost.csv", sep=";", index=False, encoding="utf-8")

print("Fichier 'prediction_1year_all_cities_xgboost.csv' créé.")
print("Aperçu :")
